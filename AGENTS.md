...
- `get_ngram_probability(tokens)` - Returns probability score (with smoothing)
- `detect_errors(text)` - Returns list of (sentence, probability) tuples for low-probability text
